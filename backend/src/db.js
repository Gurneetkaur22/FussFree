...
async function initDB() {
  ...
  const dbName = process.env.DB_NAME || "fussfree_db";
  ...
  if (adminRows[0].count === 0) {
    ...
    console.log(
      "✅ Default admin created: admin@fussfree.com / admin123"
    );
  }
  ...
  // Add user_id for older databases
  try {
    await conn.query(`
  ...
  if (rows[0].count === 0) {
    await conn.query(`
      ...
      (category, description, location, priority, status, created_at)
      VALUES
      (
        'Ragging',
        'Ragging incident in college hostel',
        '28.6139,77.2090',
        'High',
        'Pending',
      ...
      (
        'Harassment',
        'Someone harassed me near campus gate',
        '28.6129,77.2295',
        'High',
        'Resolved',
      ...
      (
        'Discrimination',
        'Discriminatory behavior by staff',
        '28.5355,77.3910',
        'Low',
        'Resolved',
      ...
      (
        'Ragging',
        'Seniors forcing juniors to do tasks',
        '28.4595,77.0266',
        'High',
        'Pending',
