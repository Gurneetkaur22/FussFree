    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      <Card className="w-full max-w-sm shadow-2xl">
        <CardHeader className="gradient-primary rounded-t-lg text-center pb-6">
          ...
          <CardTitle className="text-xl font-bold text-primary-foreground">User Login</CardTitle>
          <p className="text-primary-foreground/70 text-sm mt-1">FussFree — Campus Safety</p>
        </CardHeader>
